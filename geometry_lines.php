     ...
     <div class="container">
        ...
        <section class="first_cont">
            ...
            <div class="flex_cont parallel_cont">
                ...
                <div class="flex_item">
                    <p>Уравнение прямой в прямоугольной системе координат является уравнением первой степени. y = ax + b</p>
                    <p>Число a называется угловым коэффициентом прямой</p>
                    <p>Две параллельные прямые, не параллельные оси O<sub>y</sub>, имеют одинаковые угловые коэффициенты; если две прямые имеют одинаковые угловые коэффициенты, то эти прямые параллельны</p>
                    <p>Угловой коэффициент прямой k равен тангенсу угла наклона прямой к положительному направлению оси O<sub>x</sub>, т.е. k = tg α</p>
                    <img src="img/parallel-12.svg" alt="" class="line">
                </div>
            </div>
        </section>
            ...
            <div class="cont_with_el">
                ...
                <div class="el">
                    <div class="container_with_fraction">
                        <p>Градусная мера угла в 1 радиан составляет (</p>
                        <div class="elem">
                            <div class="fraction">
                                <p>180</p>
                                <hr>
