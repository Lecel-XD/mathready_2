    ...
    <?php 
     ...
     <div class="container">
        ...
        <section class="first_cont">
            ...
            <div class="parallel_cont flex_cont second">
                <div class="flex_item">
                    <p>y = ax + b, где a – угловой коэффициент. Если две прямые имеют одинаковые угловые коэффициенты, то эти прямые параллельны</p>
                    <p>Угловой коэффициент равен тангенсу угла наклона прямой к положительному направлению оси O<sub>x</sub>, т.е. a = tg α</p>
                    <img src="img/corner_coef-1.svg" alt="" class="line">
                </div>
            </div>
        </section>
        ...
        <section class="corner">
            ...
            <div class="cont_with_el">
                ...
                <div class="el">
                    ...
                    <img src="img/1_rad_corner.svg" alt="">
                </div>
            </div>
        </section>
