        ...
        <section class="vectors_planimetry">
            ...
            <div class="box">
                <div class="flex_box">
                    ...
                    <p>При умножениее вектора <b class="arrow">a</b> на число k получается вектор, длина которого в k раз отличается от длины <b class="arrow">a</b></p>
            ...
            <div class="box">
                ...
                <div class="flex_box">
                    <div class="column">
                        ...
                        <p>Чтобы сложить векторы <b class="arrow">a</b> и <b class="arrow">b</b>, помещаем начала обоих в одну точку. Достраиваем до параллелограмма и из той же точки проводим диагональ параллелограмма. Это и будет сумма векторов <b class="arrow">a</b> и <b class="arrow">b</b></p>
                    </div>
                    <img src="" alt="">
                </div>
                <div class="flex_box">
                    <div class="column">
                        ...
                        <p>Возьмём векторы <b class="arrow">a</b> и <b class="arrow">b</b>. К концу первого вектора пристроим начало второго. Соединим начало первого и конец второго. Это и есть сумма вектором <b class="arrow">a</b> и <b class="arrow">b</b></p>
                    </div>
                    <img src="" alt="">
                </div>
            </div>
